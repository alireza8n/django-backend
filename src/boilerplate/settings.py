...
USE_I18N = BOOLEAN_MAP.get(getenv("USE_I18N"), True)
USE_L10N = BOOLEAN_MAP.get(getenv("USE_L10N"), True)
USE_TZ = BOOLEAN_MAP.get(getenv("USE_TZ"), True)
...
AWS_S3_CUSTOM_DOMAIN = f"{AWS_HOST}/{AWS_STORAGE_BUCKET_NAME}"
